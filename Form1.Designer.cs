...
partial class Form1
{
  ...
  private System.Windows.Forms.Button buttonImportRiders;
  ...
  private void InitializeComponent()
  {
    ...
    buttonImportRiders = new Button();
    labelImportStatus = new Label();
    ...
    buttonStart.Size = new Size(137, 38);
    ...
    buttonStop.Location = new Point(343, 20);
    buttonStop.Margin = new Padding(4, 5, 4, 5);
    buttonStop.Name = "buttonStop";
    buttonStop.Size = new Size(147, 38);
    ...
    labelConnections.Location = new Point(491, 27);
    ...
    // buttonShowSummary
    // 
    buttonShowSummary.Location = new Point(632, 20);
    ...
    // buttonClearRiders
    // 
    buttonClearRiders.Location = new Point(790, 20);
    ...
    // 
    buttonGenerateReport.Location = new Point(932, 20);
    ...
    // buttonImportRiders
    // 
    buttonImportRiders.Location = new Point(1092, 20);
    buttonImportRiders.Margin = new Padding(4, 5, 4, 5);
    buttonImportRiders.Name = "buttonImportRiders";
    buttonImportRiders.Size = new Size(150, 38);
    buttonImportRiders.TabIndex = 11;
    buttonImportRiders.Text = "Import Riders";
    buttonImportRiders.UseVisualStyleBackColor = true;
    buttonImportRiders.Click += buttonImportRiders_Click;
    // 
    // labelImportStatus
    // 
    labelImportStatus.AutoSize = true;
    labelImportStatus.ForeColor = Color.DarkGreen;
    labelImportStatus.Location = new Point(1252, 29);
    labelImportStatus.Margin = new Padding(4, 0, 4, 0);
    labelImportStatus.Name = "labelImportStatus";
    labelImportStatus.Size = new Size(0, 25);
    labelImportStatus.TabIndex = 12;
    // 
    // labelRaceDuration
    // 
    ...
    // buttonSetDuration
    // 
    buttonSetDuration.Location = new Point(497, 26);
    ...
    tabPageRiders.Controls.Add(comboBoxClassFilter);
    tabPageRiders.Controls.Add(labelClassFilter);
    ...
    dataGridViewRiders.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
    dataGridViewRiders.Location = new Point(4, 40);
    ...
    dataGridViewRiders.Size = new Size(1641, 834);
    dataGridViewRiders.TabIndex = 0;
    // 
    // comboBoxClassFilter
    // 
    comboBoxClassFilter.DropDownStyle = ComboBoxStyle.DropDownList;
    comboBoxClassFilter.Location = new Point(80, 8);
    comboBoxClassFilter.Name = "comboBoxClassFilter";
    comboBoxClassFilter.Size = new Size(200, 28);
    comboBoxClassFilter.TabIndex = 1;
    comboBoxClassFilter.SelectedIndexChanged += ComboBoxClassFilter_SelectedIndexChanged;
    // 
    // labelClassFilter
    // 
    labelClassFilter.AutoSize = true;
    labelClassFilter.Location = new Point(8, 11);
    labelClassFilter.Name = "labelClassFilter";
    labelClassFilter.Size = new Size(66, 20);
    labelClassFilter.TabIndex = 2;
    labelClassFilter.Text = "Filter by:";
    // 
    // tabPageStats
    // 
    ...
    // 
    buttonSetShortLapSettings.Location = new Point(497, 108);
    ...
    // 
    numericUpDownMinimumLapTime.Location = new Point(318, 113);
    ...
    labelMinimumLapTime.Location = new Point(29, 115);
    ...
    // 
    numericUpDownAdditionalLaps.Location = new Point(318, 72);
    ...
    // 
    buttonSetAdditionalLaps.Location = new Point(497, 67);
    ...
    groupBoxRaceStart.Location = new Point(29, 268);
    ...
    checkBoxFilterEnabled.Text = "Enabled";
